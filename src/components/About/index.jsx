  ...
  return (
    <div className="w-full shadow-sm">
      <div
        ref={ref}
        id={id}
        className="CONTAINER max-w-5xl mx-auto px-5 t:px-10 d:px-12 pb-20 pt-10 d:pt-20 flex flex-col d:flex-row items-center justify-center gap-4"
      >
        ...
        <div className="max-w-[30rem] h-full flex flex-col gap-3 text-center d:text-start">
          ...
          <p className="text-2xl font-extrabold">
            Full-Stack Developer<br></br> based in Qinhuangdao,<br className="t:hidden"></br> China
            📍
          </p>
          <p className="text-lght-blk text-lg">
            Hey, my name is Oussama, and I'm a Web Developer. passionate to create and develop clean
