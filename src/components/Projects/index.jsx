...
const Projects = forwardRef(({ id }, ref) => {
  return (
    <div className="w-full shadow-sm">
      ...
      >
        <p className="text-2xl font-extrabold pb-8 text-blue">PROJECTS</p>
        <div className="w-full h-full flex gap-8 flex-col d:flex-row">
          <div className="w-full d:w-[50%] h-fit d:h-[14rem] border rounded shadow-shdw-lg overflow-hidden">
            <a href="https://primecasuals.com" target="blank">
              <img src="./projects/projectone.png" alt="project1" className="animate-image" />
            </a>
          </div>
          <div className="w-full d:w-[50%] h-fit d:h-[14rem] border rounded shadow-shdw-lg overflow-hidden">
            <img src="./projects/projecttwo.png" alt="project2" className="w-full" />
          </div>
        </div>
      </div>
    </div>
