  ...
  return (
    <div className="w-full shadow-sm bg-gry">
      <div
        ref={ref}
        id={id}
        className="CONTAINER max-w-5xl mx-auto h-fit px-5 t:px-10 d:px-12 py-20 flex flex-col gap-4 text-center t:text-start"
      >
        <p className="text-2xl font-extrabold text-blue">CONTACT</p>
